...
{
    public class SliderCrankCad : Base
    {
        #region Fields

        private readonly SliderCrankCadInfo _info;
        ...
        public SliderCrankCad(SliderCrankCadInfo info) : base(info)
        {
            _info = info;
    ...
    [Serializable, XmlInclude(typeof(SliderCrankCadInfo)), XmlType(TypeName = "Experior.Catalog.Joints.Assemblies.Mechanisms.SliderCrankCadInfo")]
    public class SliderCrankCadInfo : BaseInfo
    {
