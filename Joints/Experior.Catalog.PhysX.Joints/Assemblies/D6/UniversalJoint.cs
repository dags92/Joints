...
{
    public class UniversalJoint : Base
    {
        #region Fields

        private readonly UniversalJointInfo _info;

        private readonly Actuators.Motors.Rotative _motor;

        private bool flagX, flagY;

        #endregion

        #region Constructor

        public UniversalJoint(UniversalJointInfo info)
            : base(info)
        {
            _info = info;
        ...
        public override void Step(float deltatime)
        {
            ...
            {
                jointD6.DriveAngularVelocity = new Vector3(flagY ? _motor.CurrentSpeed : 0f, flagX ? _motor.CurrentSpeed * 1.5f : 0f, 0);
            }
        }
    ...
    [Serializable, XmlInclude(typeof(UniversalJointInfo)), XmlType(TypeName = "Experior.Catalog.Joints.Assemblies.D6.UniversalJointInfo")]
    public class UniversalJointInfo : BaseInfo
    {
