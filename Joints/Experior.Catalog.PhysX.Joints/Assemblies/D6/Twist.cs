...
{
    public class Twist : Base
    {
        #region Fields

        private readonly TwistInfo _info;
        ...
        public Twist(TwistInfo info) : base(info)
        {
            _info = info;
    ...
    [Serializable, XmlInclude(typeof(TwistInfo)), XmlType(TypeName = "Experior.Catalog.Joints.Assemblies.D6.TwistInfo")]
    public class TwistInfo : BaseInfo
    {
