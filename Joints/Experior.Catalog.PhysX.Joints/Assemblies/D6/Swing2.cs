...
{
    public class Swing2 : Base
    {
        #region Fields

        private readonly Swing2Info _info;
        ...
        public override ImageSource Image => Common.Icon.Get("Swing2");
        ...
        public override void Step(float deltatime)
        {
            ...
            {
                jointD6.DriveAngularVelocity = new Vector3(0, 0, _motor.CurrentSpeed);
            }
        }
    ...
    [Serializable, XmlInclude(typeof(Swing2Info)), XmlType(TypeName = "Experior.Catalog.Joints.Assemblies.D6.Swing2Info")]
    public class Swing2Info : BaseInfo
    {
